...
function countVowels(str) {
  const vowelRegex = /[aeiouy]/gi; // Case-insensitive match for vowels
...
function isPalindrome(str) {
  const cleanedStr = str.toLowerCase().replace(/[.,?! ]/g, ''); // Use a regular expression to remove punctuation and spaces
